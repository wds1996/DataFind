...
public class Apriori_test1 {
    ...
    public Map<String, Integer> find1_FrequentSet(ArrayList<String> dataList){
    ...
    public boolean hasInfrequentSubset(String candidateString, Map<String, Integer> setMap){
     ...
     * @return
     */
    public Map<String,Integer> aprioriGen(Map<String, Integer> setMap){
        //此处传入的参数就是上面返回的频繁项集。
    ...
    public List<String> subset(String sourceSet){
     ...
     * 集合运算，A/B
     */
    public String expect(String stringA, String stringB){
        String result = "";
    ...
    public static void main(String[] args) {
        ...
        Apriori_test1 apriori2 = new Apriori_test1();
